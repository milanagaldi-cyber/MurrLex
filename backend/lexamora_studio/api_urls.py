...
urlpatterns = [
    ...
    path("projects/<uuid:project_id>/members", api.project_members, name="project_members"),
    path("projects/<uuid:project_id>/members/<uuid:membership_id>", api.project_member_detail, name="project_member_detail"),
