...
urlpatterns = [
    ...
    path("preferences/ai-toggle/", views.ai_usage_toggle, name="ai_usage_toggle"),
    ...
    path("projects/<uuid:project_id>/media/direct/", views.project_media_upload, name="project_media_upload"),
    path("projects/<uuid:project_id>/movie-editor/media/<uuid:asset_id>/retry/", views.project_movie_media_retry, name="project_movie_media_retry"),
    path("projects/<uuid:project_id>/movie-editor/renders/", views.project_movie_renders, name="project_movie_renders"),
    path("projects/<uuid:project_id>/movie-editor/renders/<uuid:job_id>/", views.project_movie_render_job, name="project_movie_render_job"),
    path("projects/<uuid:project_id>/movie-editor/revisions/", views.project_movie_editor_revisions, name="project_movie_editor_revisions"),
    path("projects/<uuid:project_id>/movie-editor/revisions/<uuid:revision_id>/restore/", views.project_movie_editor_revision_restore, name="project_movie_editor_revision_restore"),
    path("projects/<uuid:project_id>/movie-editor-2/", views.project_movie_editor_2, name="project_movie_editor_2"),
