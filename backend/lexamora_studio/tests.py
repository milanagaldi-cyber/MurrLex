...
class StudioProductionPilotFeaturesTests(TestCase):
    ...
    def test_movie_editor_saves_project_timeline(self):
        ...
        self.assertContains(page, 'data-panel-resizer="media"', count=4)
        self.assertContains(page, 'data-panel-resizer="preview"', count=4)
        self.assertContains(page, 'data-panel-resizer="inspector"', count=4)
