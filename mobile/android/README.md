...
Current app version: `0.94-rive-sort`.
...
- v0.94 adds the full-screen `Rive Character Sort` puzzle: 24 hero tiles, a seven-slot tray, triple matching, combo scoring, a 75-second round, episode results, a live Rive mascot, and separate `arm64-v8a` / `x86_64` debug APKs.
